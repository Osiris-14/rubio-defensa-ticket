-- =====================================================================
-- FIX 2026-07-22 — RPC confirm_production_step: columna ambigua
-- + agregar piezas faltantes al catálogo con precio 0 (para que no bloquee)
-- =====================================================================

-- 1) Fix: RETURNING id era ambiguo con la columna id del RETURNS TABLE
...
BEGIN
  ...
  -- Si no hay precio en el catálogo → precio 0 (no bloquear al operador)
  -- El administrador puede actualizar el precio después.
