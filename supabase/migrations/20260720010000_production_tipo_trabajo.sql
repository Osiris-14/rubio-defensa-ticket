-- =====================================================================
-- MIGRATION ADICIONAL: Tipo de trabajo + Grado de reparación
-- en production_tickets (idempotente, seguro correr varias veces)
-- =====================================================================
...
-- 2) Recrear la RPC create_production_ticket para aceptar y persistir
--    los nuevos campos.
